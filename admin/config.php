<?php
// HTTP
define('HTTP_SERVER', 'http://opencart:81/admin/');
define('HTTP_CATALOG', 'http://opencart:81/');

// HTTPS
define('HTTPS_SERVER', 'http://opencart:81/admin/');
define('HTTPS_CATALOG', 'http://opencart:81/');
